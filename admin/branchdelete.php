...
$qry="delete from branch where bid='$bid'";
...
$qry="select * from branch, area where bid='$bid'";
$result=$conn->query($qry);
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" id="form-field-1" name="areaid" value="<?php echo $areaname ?>" class="col-xs-5 col-sm-5">
</div>
<br>
<br>
<br>
