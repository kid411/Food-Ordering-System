...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" id="form-field-1" name="catid" value="<?php echo $catid; ?>" class="col-xs-5 col-sm-5">
</div>
    ...
    <div class="col-sm-3">
        <input type="text" id="form-field-1" name="pdesc" value="<?php echo $pdesc; ?>" class="col-xs-5 col-sm-12">
</div>
<br>
<br>
<br>
